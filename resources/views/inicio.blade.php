...
<main class="main">
  ...
  <section id="hero" class="hero section">
    {{-- La imagen de Muro ya está dinámica, eso está perfecto --}}
    @if($imagenMuro)
    ...
    <div class="container text-center" data-aos="zoom-out" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-lg-8">
          ...
          {{-- Usamos la variable '$datos' y los campos correctos de la base de datos --}}
          @if($datos)
          <h2>{{ $datos->nombre }} {{ $datos->apellido }}</h2>
          {{-- El efecto "typed" ahora mostrará la carrera y la frase --}}
          <p>Soy <span class="typed" data-typed-items="{{ $datos->carrera }}, {{ $datos->frase }}"></span></p>
